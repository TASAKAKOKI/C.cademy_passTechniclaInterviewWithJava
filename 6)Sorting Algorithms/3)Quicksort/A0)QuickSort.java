'''
The main method has been filled out with QuickSort running on an integer array called unsorted. Click Run on the code as is to see that our implementation indeed gave us a correct sort!

Then, going over the code in quickSort() and partition(), uncomment out the print statements that print out what is happening in the middle of the execution. Run again with the print statements to see our intermediate steps!
'''

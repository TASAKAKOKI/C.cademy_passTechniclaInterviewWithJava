...
Access Modifiers
    In Java, there are four access modifiers that restrict the accessibility of the method or variable to which the modifier is applied. They are only used within classes, not within methods. public and private are the most relevant modifiers to our work, but we will briefly discuss all of them.
        ...
        default: Allows access only from within the current package. If there is no specified access modifier, the method or variable will take on this one. Learn more about this at <javarevisited.blogspot.com/2012/10/difference-between-private-protected-public-package-access-java.html#axzz6bsLddljT>
...
Instance Variables
    ...
    Here are two other frequent uses of this:
        ...
        this is a very handy tool used in Java to simplify and disambiguate code. Although this is the case, there are different preferences(softwareengineering.stackexchange.com/questions/113430/what-is-the-accepted-style-for-using-the-this-keyword-in-java) for the contexts in which to use it.   
Graph Search Traversal Order
    ...
    Well, it turns out that in "addition to path-finding", "depth-first search(DFS)" is pretty "adept at organizing vertices (or vertex values) with a clear order of visitation from beginning to end".
